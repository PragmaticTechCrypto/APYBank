...
// SPDX-License-Identifier: None
    ...
    contract APYBank is ERC20Detailed, Ownable, ReentrancyGuard {
        ...
        address private liquidityReceiver = 0x0098C068cB09D0f1125ab7E24044f0c0D2e8DFB2;
        address private treasuryReceiver = 0xa2a0504b9b5365CFd7cD0B11538D5804A98f8Eaa;
        address private riskFreeValueReceiver = 0xA88e5269BE03b3a913A9B6EC98D9E97E02eAde96;
        address private operationsFeeReceiver = 0xC3Fa5F65890bdfaac35890EF97653442325827B7;
        ...
        function setMaxWalletDenom(uint256 _maxWalletDenom) external onlyOwner {
            require(_maxWalletDenom > 0 && _maxWalletDenom <= 10000, "Can't be too high or zero");
        ...
        function setMaxSellTransactionDenom(uint256 _maxSellDenom) external onlyOwner {
            require(_maxSellDenom > 0 && _maxSellDenom <= 10000, "Can't be too high or zero");
